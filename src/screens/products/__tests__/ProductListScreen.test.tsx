...
jest.mock('@react-navigation/native', () => {
  ...
  return {
    ...
    // No-op mock - useEffect will handle initial load in tests
...
jest.mock('@/database/connection', () => ({
  getDatabase: jest.fn().mockReturnValue(Promise.resolve({})),
}));

// Mock repositories with SYNCHRONOUS resolve to avoid async issues
...
describe('ProductListScreen', () => {
  test('1. renders with empty state', async () => {
    ...
    // Allow useEffect to run and data to load
    await act(async () => {
